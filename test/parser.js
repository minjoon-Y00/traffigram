...
function parser(Style, Fill, Stroke, Icon, Text) {
  ...
  return function(feature, resolution) {
    ...
    // road: motorway, motorway_link, main, street, street_limited, 
    //   [path], [service], [major_rail]

    // bridge: motorway, motorway_link, main, street, street_limited, 
    //   [path], [service], [major_rail]
    ...
    // landuse: park, wood, school, cemetery, hospital,
    //   [grass], [sand], [parking], [scrub], [pitch], [agriculture] 

    // place_label: city, tow, village, hamlet, suburb, neighbourhood



    if (layer == 'place_label') {
      //if (cls != 'path') return null;
      //if (type != 'neighbourhood') return null;
      //console.log(type);
    }
    else return null;
